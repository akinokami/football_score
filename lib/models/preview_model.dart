class PreviewModel {
  ...
  PreviewModel({this.template, this.title, this.preData, this.scheme});
...
class PreData {
  ...
  PreData({this.statistic, this.matches});
...
class Matches {
  ...
  Matches.fromJson(Map<String, dynamic> json) {
    ...
    awayTeam =
        json['away_team'] != null ? HomeTeam.fromJson(json['away_team']) : null;
