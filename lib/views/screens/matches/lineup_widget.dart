...
class LineupWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return (lineupModel?.lupList?.length ?? 0) > 0
        ? (lineupModel?.lupList?[0].lupData?.home?.start?.length ?? 0) > 0
            ? Padding(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    if ((lineupModel
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          if ((lineupModel?.lupList?[0].lupData?.away?.start
                                      ?.length ??
                                  0) >
                              0)
                            Expanded(
                    ...
                    if ((lineupModel?.lupList?[0].lupData?.home?.sub?.length ??
                            0) >
                        0)
                    ...
                    if ((lineupModel?.lupList?[0].lupData?.home?.sub?.length ??
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          if ((lineupModel?.lupList?[0].lupData?.away?.sub
                                      ?.length ??
                                  0) >
                              0)
                            Expanded(
