      ...
      child: Column(
        children: [
          ...
          statisticModel.isEmpty
              ...
              : statisticModel['data']['statistics'] != []
                  ? ListView.builder(
                      physics: const NeverScrollableScrollPhysics(),
                      shrinkWrap: true,
                      itemCount: statisticModel['data']['statistics'].length,
                          ...
                          child: Row(
                            ...
                            children: [
                              SizedBox(
                                ...
                                child: CustomText(
                                    size: 8.sp,
                                    text: statisticModel['data']['statistics']
                                        [index]['home_team_value']),
                              ),
                              AnimatedProgressIndicator(
                                  value: (statisticModel['data']['statistics']
                                                  [index]['name'] ==
                                              'Attacks' ||
                                          statisticModel['data']['statistics']
                                                  [index]['name'] ==
                                              'Dangerous Attacks')
                                      ? double.parse(statisticModel['data']['statistics']
                                              [index]['home_team_value']) /
                                          200
                                      : double.parse(statisticModel['data']['statistics']
                                              [index]['home_team_value']) /
                                ...
                                if (eventModel['data']['events'][index]
                                  ...
                                  Expanded(
                                    child: ListView.builder(
                                        ...
                                        itemCount: eventModel['data']['events']
                                                [index]['home']
                                            .length,
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                (eventModel['data']['events'][index]
                                                    ...
                                                    : (eventModel['data']['events'][index]['home'][homeIndex]['code'] == "G" ||
                                                            eventModel['data']['events'][index]
                                                                        ['home']
                                                                    [homeIndex]['code'] ==
                                                                "OG" ||
                                                            eventModel['data']['events'][index]['home'][homeIndex]['code'] == "PG")
                                                        ? Icon(
                                                            Icons.sports_soccer,
                                                        ...
                                                        : (eventModel['data']['events'][index]['home'][homeIndex]['code'] == "SO" || eventModel['data']['events'][index]['home'][homeIndex]['code'] == "SI")
                                                            ? Icon(
                                                                eventModel['data']['events'][index]['home'][homeIndex]
                                                                            [
                                                                            'code'] ==
                                                            ...
                                                            : eventModel['data']['events'][index]['home'][homeIndex]['code'] == "VAR"
                                                                ? const Text("VAR", style: TextStyle(color: Colors.red, fontSize: 8))
                                                                : Image.asset(
                                                                    "assets/images/assist.webp",
                                                                    width: 15,
                                                                    height: 15,
                                                                  ),
                                                kSizedBoxW10,
                                              ...
                                              children: [
                                                ...
                                                if (eventModel['data']['events']
                                                  ...
                                                  (eventModel['data']['events'][index]['away']
                                                      ...
                                                      : (eventModel['data']['events'][index]['away'][awayIndex]['code'] == "G" ||
                                                              eventModel['data']['events'][index]['away'][awayIndex]['code'] == "OG" ||
                                                              eventModel['data']['events'][index]['away'][awayIndex]['code'] == "PG")
                                                          ? Icon(
                                                              Icons
                                                                  .sports_soccer,
                                                          ...
                                                          : (eventModel['data']['events'][index]['away'][awayIndex]['code'] == "SO" || eventModel['data']['events'][index]['away'][awayIndex]['code'] == "SI")
                                                              ? Icon(
                                                                  eventModel['data']['events'][index]['away'][awayIndex]
                                                                              [
                                                                              'code'] ==
                                                              ...
                                                              : eventModel['data']['events'][index]['away'][awayIndex]['code'] == "VAR"
                                                                  ? const Text("VAR", style: TextStyle(color: Colors.red, fontSize: 8))
                                                                  : Image.asset(
                                                                      "assets/images/assist.webp",
                                                                      width: 15,
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    CustomText(size: 8.sp, text: 'Half Time'),
                                    SizedBox(
                                      width: MediaQuery.of(context).size.width *
                                          .40,
                                      child: Divider(
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    CustomText(size: 8.sp, text: 'Full Time'),
                                    SizedBox(
                                      width: MediaQuery.of(context).size.width *
                                          .40,
                                      child: Divider(
